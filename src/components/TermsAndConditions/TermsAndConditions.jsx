...
const TermsAndConditions = () => {
  return (
    <section id="termsandcond">
      <header>
        <p>CURRENT AS OF MAY 2024</p>
        <h1>Terms & Conditions</h1>
      </header>
      <div className="content">
        <p>
          Welcome to LUXURY VILLA RENTALS. Please read these terms and
        ...
        <ul>
          ...
          <li>
            ...
            <ol>
              <li>
                ...
                graphics, logos, images, and software, is the property of LUXURY
                VILLA RENTALS and is protected by copyright, trademark, and
          ...
          <li>
            ...
            <p>
              To the fullest extent permitted by applicable law, LUXURY VILLA
              RENTALS shall not be liable for any indirect, incidental, special,
